...
*UC Berkeley (BGA) · SWUFE · ACL 2026 Findings*
...
- 📄 **Co-first Author** on a paper accepted to **ACL 2026 Findings** — a dual-process cognitive architecture for role-playing agents that reduces persona drift by 75% and token cost by 87%
...
### 🧠 [PersonaForge](https://github.com/fQwQf/PersonaForge) — Role-Playing Agent with Dual-Process Architecture
*Co-first Author · ACL 2026 Findings (Accepted)*
